...
{
    [ApiController]
    [Route("weatherforecast_challenge8/{id}")]
    public class Challenge8Controller: ControllerBase
    {
        ...
        private readonly ILogger<Challenge8Controller> _logger;

        public Challenge8Controller(ILogger<Challenge8Controller> logger)
        {
            _logger = logger;
        }
