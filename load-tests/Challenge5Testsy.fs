...
[<Fact>]
let ``Challenge 5`` () =
    let step1 = HttpStep.create ("simple step", (fun (_sc: StepContext<unit> ) ->  Http.createRequest "GET" "https://localhost:5001/weatherforecast_challenge5")) 
    ...
    let scenario =
        Scenario.create "Challenge 5" [step1]
